...
!function(o,t,e,a){"use strict";var r={scale:1,zoom:!0,enableZoomAfter:300},s=function(e){return this.core=o(e).data("lightGallery"),this.core.s=o.extend({},r,this.core.s),this.core.s.zoom&&this.core.doCss()&&(this.init(),this.zoomabletimeout=!1,this.pageX=o(t).width()/2,this.pageY=o(t).height()/2+o(t).scrollTop()),this};s.prototype.init=function(){var e=this,a='<span id="lg-zoom-in" class="lg-icon"></span><span id="lg-zoom-out" class="lg-icon"></span>';this.core.$outer.find(".lg-toolbar").append(a),e.core.$el.on("onSlideItemLoad.lg.tm.zoom",function(t,a,r){var s=e.core.s.enableZoomAfter+r;o("body").hasClass("lg-from-hash")&&r?s=0:o("body").removeClass("lg-from-hash"),e.zoomabletimeout=setTimeout(function(){e.core.$slide.eq(a).addClass("lg-zoomable")},s+30)});var r=1,s=function(a){var r,s,i=e.core.$outer.find(".lg-current .lg-image"),l=(o(t).width()-i.width())/2,n=(o(t).height()-i.height())/2+o(t).scrollTop();r=e.pageX-l,s=e.pageY-n;var c=(a-1)*r,g=(a-1)*s;i.css("transform","scale3d("+a+", "+a+", 1)").attr("data-scale",a),i.parent().css("transform","translate3d(-"+c+"px, -"+g+"px, 0)").attr("data-x",c).attr("data-y",g)},i=function(){r>1?e.core.$outer.addClass("lg-zoomed"):e.resetZoom(),1>r&&(r=1),s(r)},l=function(o,t,a){var s,l=t.width();s=e.core.s.dynamic?e.core.s.dynamicEl[a].width||t[0].naturalWidth||l:e.core.$items.eq(a).attr("data-width")||t[0].naturalWidth||l;var n;e.core.$outer.hasClass("lg-zoomed")?r=1:s>l&&(n=s/l,r=n||2),e.pageX=o.pageX||o.originalEvent.targetTouches[0].pageX,e.pageY=o.pageY||o.originalEvent.targetTouches[0].pageY,i(),setTimeout(function(){e.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")},10)},n=!1;e.core.$el.on("onAferAppendSlide.lg.tm.zoom",function(o,t){var a=e.core.$slide.eq(t).find(".lg-image");a.on("dblclick",function(o){l(o,a,t)}),a.on("touchstart",function(o){n?(clearTimeout(n),n=null,l(o,a,t)):n=setTimeout(function(){n=null},300),o.preventDefault()})}),o(t).on("resize.lg.zoom scroll.lg.zoom orientationchange.lg.zoom",function(){e.pageX=o(t).width()/2,e.pageY=o(t).height()/2+o(t).scrollTop(),s(r)}),o("#lg-zoom-out").on("click.lg",function(){e.core.$outer.find(".lg-current .lg-image").length&&(r-=e.core.s.scale,i())}),o("#lg-zoom-in").on("click.lg",function(){e.core.$outer.find(".lg-current .lg-image").length&&(r+=e.core.s.scale,i())}),e.core.$el.on("onBeforeSlide.lg.tm",function(){r=1,e.resetZoom()}),e.core.isTouch||e.zoomDrag(),e.core.isTouch&&e.zoomSwipe()},s.prototype.resetZoom=function(){this.core.$outer.removeClass("lg-zoomed"),this.core.$slide.find(".lg-img-wrap").removeAttr("style data-x data-y"),this.core.$slide.find(".lg-image").removeAttr("style data-scale"),this.pageX=o(t).width()/2,this.pageY=o(t).height()/2+o(t).scrollTop()},s.prototype.zoomSwipe=function(){var o=this,t={},e={},a=!1,r=!1,s=!1;o.core.$slide.on("touchstart.lg",function(e){if(o.core.$outer.hasClass("lg-zoomed")){var a=o.core.$slide.eq(o.core.index).find(".lg-object");s=a.outerHeight()*a.attr("data-scale")>o.core.$outer.find(".lg").height(),r=a.outerWidth()*a.attr("data-scale")>o.core.$outer.find(".lg").width(),(r||s)&&(e.preventDefault(),t={x:e.originalEvent.targetTouches[0].pageX,y:e.originalEvent.targetTouches[0].pageY})}}),o.core.$slide.on("touchmove.lg",function(i){if(o.core.$outer.hasClass("lg-zoomed")){var l,n,c=o.core.$slide.eq(o.core.index).find(".lg-img-wrap");i.preventDefault(),a=!0,e={x:i.originalEvent.targetTouches[0].pageX,y:i.originalEvent.targetTouches[0].pageY},o.core.$outer.addClass("lg-zoom-dragging"),n=s?-Math.abs(c.attr("data-y"))+(e.y-t.y):-Math.abs(c.attr("data-y")),l=r?-Math.abs(c.attr("data-x"))+(e.x-t.x):-Math.abs(c.attr("data-x")),(Math.abs(e.x-t.x)>15||Math.abs(e.y-t.y)>15)&&c.css("transform","translate3d("+l+"px, "+n+"px, 0)")}}),o.core.$slide.on("touchend.lg",function(){o.core.$outer.hasClass("lg-zoomed")&&a&&(a=!1,o.core.$outer.removeClass("lg-zoom-dragging"),o.touchendZoom(t,e,r,s))})},s.prototype.zoomDrag=function(){var e=this,a={},r={},s=!1,i=!1,l=!1,n=!1;e.core.$slide.on("mousedown.lg.zoom",function(t){var r=e.core.$slide.eq(e.core.index).find(".lg-object");n=r.outerHeight()*r.attr("data-scale")>e.core.$outer.find(".lg").height(),l=r.outerWidth()*r.attr("data-scale")>e.core.$outer.find(".lg").width(),e.core.$outer.hasClass("lg-zoomed")&&o(t.target).hasClass("lg-object")&&(l||n)&&(t.preventDefault(),a={x:t.pageX,y:t.pageY},s=!0,e.core.$outer.scrollLeft+=1,e.core.$outer.scrollLeft-=1,e.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))}),o(t).on("mousemove.lg.zoom",function(o){if(s){var t,c,g=e.core.$slide.eq(e.core.index).find(".lg-img-wrap");i=!0,r={x:o.pageX,y:o.pageY},e.core.$outer.addClass("lg-zoom-dragging"),c=n?-Math.abs(g.attr("data-y"))+(r.y-a.y):-Math.abs(g.attr("data-y")),t=l?-Math.abs(g.attr("data-x"))+(r.x-a.x):-Math.abs(g.attr("data-x")),g.css("transform","translate3d("+t+"px, "+c+"px, 0)")}}),o(t).on("mouseup.lg.zoom",function(o){s&&(s=!1,e.core.$outer.removeClass("lg-zoom-dragging"),!i||a.x===r.x&&a.y===r.y||(r={x:o.pageX,y:o.pageY},e.touchendZoom(a,r,l,n)),i=!1),e.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")})},s.prototype.touchendZoom=function(o,t,e,a){var r=this,s=r.core.$slide.eq(r.core.index).find(".lg-img-wrap"),i=r.core.$slide.eq(r.core.index).find(".lg-object"),l=-Math.abs(s.attr("data-x"))+(t.x-o.x),n=-Math.abs(s.attr("data-y"))+(t.y-o.y),c=(r.core.$outer.find(".lg").height()-i.outerHeight())/2,g=Math.abs(i.outerHeight()*Math.abs(i.attr("data-scale"))-r.core.$outer.find(".lg").height()+c),d=(r.core.$outer.find(".lg").width()-i.outerWidth())/2,h=Math.abs(i.outerWidth()*Math.abs(i.attr("data-scale"))-r.core.$outer.find(".lg").width()+d);(Math.abs(t.x-o.x)>15||Math.abs(t.y-o.y)>15)&&(a&&(-g>=n?n=-g:n>=-c&&(n=-c)),e&&(-h>=l?l=-h:l>=-d&&(l=-d)),a?s.attr("data-y",Math.abs(n)):n=-Math.abs(s.attr("data-y")),e?s.attr("data-x",Math.abs(l)):l=-Math.abs(s.attr("data-x")),s.css("transform","translate3d("+l+"px, "+n+"px, 0)"))},s.prototype.destroy=function(){var e=this;e.core.$el.off(".lg.zoom"),o(t).off(".lg.zoom"),e.core.$slide.off(".lg.zoom"),e.core.$el.off(".lg.tm.zoom"),e.resetZoom(),clearTimeout(e.zoomabletimeout),e.zoomabletimeout=!1},o.fn.lightGallery.modules.zoom=s}(jQuery,window,document);
...
!function(e){var n=0,a=0,i=0,t=0,l=0,d=0,s=!0;e.fn.timeline=function(c){return this.each(function(){var o=e(this),f={getTimeLineWidth:function(){t=o.width()},getPanelNumber:function(){a=o.find(".slide-panel").length},setLayout:function(){o.find(".slide-panel").each(function(a){n=e(this).width(),e(this).css("left",n*a)})},generateNavigation:function(){o.find(".time-label").each(function(){var n=e(this).text();o.find(".slide-nav").append("<a>"+n+"</a>")})},activateNavigation:function(){o.find(".slide-nav").on("click","a",function(){i=e(this).index(),e(this).hasClass("nav-selected")||(e(".slide-nav a").removeClass("nav-selected"),e(this).addClass("nav-selected"));var l=e(".slide-panel").eq(i);l.hasClass("panel-selected")||(e(".slide-panel").removeClass("panel-selected"),l.addClass("panel-selected"));var s=(t-n)/2;e(".panel-container").animate({left:-(n*i)+s},u.panelAnimateSpeed);var c=(d-t)/a,o=0;0==i||(o=c*(i+1)),e(".slide-bg").animate({left:-o},u.backgroundAnimateSpeed)})},listenWindowSize:function(){var e=o.width();e>l&&t>l||l>e&&l>t||e>l&&l>t&&(s=!0),t=e,s&&(o.find(".slide-nav a").eq(i).trigger("click"),s=!1)}};f.getTimeLineWidth(),f.getPanelNumber(),f.generateNavigation(),f.setLayout();var r={defaultPanel:o.find(".slide-nav a:last").index(),panelAnimateSpeed:1e3,backgroundAnimateSpeed:1e3,breakpoint:648,backgroundWidth:1900},u=e.extend({},r,c);l=u.breakpoint,d=u.backgroundWidth,i=u.defaultPanel<a?u.defaultPanel:o.find(".slide-nav a:last").index(),f.activateNavigation(),l>t&&(s=!1),setInterval(f.listenWindowSize,1e3)})}}(jQuery),$(document).ready(function(){$(".timeline").timeline()});