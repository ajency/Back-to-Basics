/*
  Responsive Horizontal Time Line Plugin
  options:
    
    defaultPanel // show first, begin from 0
    panelAnimateSpeed
    backgroundAnimateSpeed
    breakpoint //should be the same as css
    backgroundWidth //should be the same as css
